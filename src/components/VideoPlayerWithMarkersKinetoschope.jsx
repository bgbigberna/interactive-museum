...
const VideoPlayerWithMarkers = () => {
  ...
  const [markers, setMarkers] = useState(() => {
    const saved = localStorage.getItem('videoBookmarksKinetoschope');
  ...
  const chapters = [
    ...
    { label: 'Chapter 3', time: 247, description: 'The history and contributions of Thomas Edison in the process of the creation of the incandescent light bulb.' },
  ...
  useEffect(() => {
    if (markers.length === 0) {
      localStorage.removeItem('videoBookmarksKinetoschope');
    } else {
      localStorage.setItem('videoBookmarksKinetoschope', JSON.stringify(markers));
    }
  }, [markers]);
